...
export const ARTICULOS_DETALLE = {
  ...
  "3": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el juicio de amparo las promociones deberán hacerse por escrito. Su presentación puede hacerse de forma electrónica o impresa. Si las partes o sus representantes cuentan con un usuario dentro del Portal de Servicios en Línea del Poder Judicial de la Federación, deberán manifestarlo desde su primera actuación en el juicio de amparo, a efecto de que sea a través de dicho medio por el cual se lleven a cabo las notificaciones correspondientes. Las autoridades que tengan suscrito Convenio de Interconexión con el Órgano de Administración Judicial y la Suprema Corte de Justicia de la Nación deberán informarlo en su primera promoción, a efecto de que las notificaciones se realicen por medio de dicho sistema. La presentación electrónica de promociones será opcional para la parte promovente, por lo que en ningún supuesto podrá condicionarse el acceso al procedimiento a la utilización de medios digitales, cuando la persona haya elegido ejercer su derecho a promover por escrito. Únicamente podrán ser orales las promociones que se hagan en las audiencias, notificaciones y comparecencias autorizadas por la ley, dejándose constancia de lo esencial. Las copias certificadas que se expidan para la substanciación del juicio de amparo no causarán contribución alguna. Los escritos en forma electrónica se presentarán mediante el empleo de las tecnologías de la información, utilizando la Firma Electrónica conforme la regulación que para tal efecto emita el Órgano de Administración Judicial. La Firma Electrónica es el medio de ingreso al sistema electrónico del Poder Judicial de la Federación y producirá los mismos efectos jurídicos que la firma autógrafa, como opción para enviar y recibir promociones, documentos, comunicaciones y notificaciones oficiales, así como consultar acuerdos, resoluciones y sentencias relacionadas con los asuntos competencia de los órganos jurisdiccionales. El Órgano de Administración Judicial, mediante acuerdos generales, determinará la forma en que deberán integrarse los expedientes físico y electrónico, salvaguardando en todo momento el derecho de las partes para consultarlos. Las personas titulares de los órganos jurisdiccionales serán las responsables de vigilar la digitalización de todas las promociones y documentos que presenten en forma física las partes, así como de los acuerdos, resoluciones o sentencias y toda información relacionada con los expedientes en el sistema. El Órgano de Administración Judicial, en ejercicio de las facultades que le confiere la Ley Orgánica del Poder Judicial de la Federación, emitirá los acuerdos generales que considere necesarios a efecto de establecer las bases y el correcto funcionamiento de la Firma Electrónica. Todas las autoridades que participen en el juicio de amparo están obligadas a generar un usuario dentro del Portal de Servicios en Línea del Poder Judicial de la Federación, a efecto de que por dicho medio actúen dentro del juicio. Las autoridades que tengan suscrito Convenio de Interconexión con el Órgano de Administración Judicial y la Suprema Corte de Justicia de la Nación podrán actuar en el juicio a través de dicho sistema. No se requerirá Firma Electrónica cuando el amparo se promueva en los términos del artículo 15 de esta Ley."
  },
  "4": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "De manera excepcional, y sólo cuando exista urgencia atendiendo al interés social o al orden público, las Cámaras del Congreso de la Unión, a través de las personas que ocupen sus presidencias, o el Ejecutivo Federal, por conducto de la persona titular de la Consejería Jurídica, podrán solicitar a la persona titular de la Presidencia de la Suprema Corte de Justicia de la Nación que un juicio de amparo, incluidos los recursos o procedimientos derivados de éste, se substancien y resuelvan de manera prioritaria, sin modificar de ningún modo los plazos previstos en la ley. La urgencia en los términos de este artículo se justificará cuando: I. Se trate de amparos promovidos para la defensa de grupos en situación de vulnerabilidad en los términos de la ley. II. Se trate del cumplimiento de decretos, resoluciones o actos de autoridad en materia de competencia económica, monopolios y libre concurrencia. III. Se trate de prevenir daños irreversibles al equilibrio ecológico. IV. En aquellos casos que el Pleno de la Suprema Corte de Justicia de la Nación estime procedentes. Recibida la solicitud, la persona titular de la Presidencia de la Suprema Corte de Justicia de la Nación la someterá a consideración del Pleno, que resolverá de forma definitiva por mayoría simple. La resolución incluirá las providencias que resulten necesarias, las que se notificarán, cuando proceda, al Órgano de Administración Judicial. Para la admisión, trámite y resolución de las solicitudes, así como las previsiones a que hace referencia este artículo, deberán observarse los acuerdos generales que al efecto emita la Suprema Corte de Justicia de la Nación."
  },
  "5": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    capitulo: "II",
    capitulo_descripcion: "Capacidad y Personería",
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Son partes en el juicio de amparo: I. La persona quejosa, teniendo tal carácter quien aduce ser titular de un derecho subjetivo o de un interés legítimo individual o colectivo, siempre que alegue que la norma, acto u omisión reclamados violan los derechos previstos en el artículo 1o. de la presente Ley y con ello se produzca una afectación real y actual a su esfera jurídica, ya sea de manera directa o en virtud de su especial situación frente al orden jurídico. Tratándose del interés legítimo, la norma, acto u omisión reclamado deberá ocasionar en la persona quejosa una lesión jurídica individual o colectiva, real y diferenciada del resto de las personas, de tal forma que su anulación produzca un beneficio cierto y no meramente hipotético o eventual en caso de que se otorgue el amparo. El interés simple, en ningún caso, podrá invocarse como interés legítimo. La autoridad pública no podrá invocar interés legítimo. El juicio de amparo podrá promoverse conjuntamente por dos o más personas quejosas cuando resientan una afectación común en sus derechos o intereses, aun en el supuesto de que dicha afectación derive de actos distintos, si éstos les causan un perjuicio análogo y provienen de las mismas autoridades. Tratándose de actos o resoluciones provenientes de tribunales judiciales, administrativos, agrarios o del trabajo, la persona quejosa deberá aducir ser titular de un derecho subjetivo que se afecte de manera personal y directa. La persona víctima u ofendida del delito podrán tener el carácter de persona quejosa en los términos de esta Ley. II. La autoridad responsable, teniendo tal carácter, con independencia de su naturaleza formal, la que dicta, ordena, ejecuta o trata de ejecutar el acto que crea, modifica o extingue situaciones jurídicas en forma unilateral y obligatoria; u omita el acto que de realizarse crearía, modificaría o extinguiría dichas situaciones jurídicas. Para los efectos de esta Ley, las y los particulares tendrán la calidad de autoridad responsable cuando realicen actos equivalentes a los de autoridad, que afecten derechos en los términos de esta fracción, y cuyas funciones estén determinadas por una norma general. III. La persona tercera interesada, pudiendo tener tal carácter: a) La persona que haya gestionado el acto reclamado o tenga interés jurídico en que subsista; b) La contraparte de la persona quejosa cuando el acto reclamado emane de un juicio o controversia del orden judicial, administrativo, agrario o del trabajo; o tratándose de persona extraña al procedimiento, la que tenga interés contrario al de la persona quejosa; c) La persona víctima del delito u ofendida, o quien tenga derecho a la reparación del daño o a reclamar la responsabilidad civil, cuando el acto reclamado emane de un juicio del orden penal y afecte de manera directa esa reparación o responsabilidad; d) La persona indiciada o procesada cuando el acto reclamado sea el no ejercicio o el desistimiento de la acción penal por la o el Ministerio Público; e) La o el Ministerio Público que haya intervenido en el procedimiento penal del cual derive el acto reclamado, siempre y cuando no tenga el carácter de autoridad responsable. IV. La o el Ministerio Público Federal en todos los juicios, donde podrá interponer los recursos que señala esta Ley, y los existentes en amparos penales cuando se reclamen resoluciones de tribunales locales, independientemente de las obligaciones que la misma ley le precisa para procurar la pronta y expedita administración de justicia. Sin embargo, en amparos indirectos en materias civil y mercantil, y con exclusión de la materia familiar, donde sólo se afecten intereses particulares, la o el Ministerio Público Federal podrá interponer los recursos que esta Ley señala, sólo cuando las personas quejosas hubieren impugnado la constitucionalidad de normas generales y este aspecto se aborde en la sentencia."
  },
  "6": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "10": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La representación de la persona quejosa y de la persona tercera interesada se acreditará en juicio en los términos previstos en esta Ley. En los casos no previstos, la personalidad en el juicio se justificará en la misma forma que determine la ley que rija la materia de la que emane el acto reclamado y cuando ésta no lo prevenga, se estará a lo dispuesto por el Código Nacional de Procedimientos Civiles y Familiares. Cuando se trate de la o el Ministerio Público o cualquier otra autoridad, se aplicarán las reglas del artículo anterior."
  },
  "11": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "24": {
    ...
    titulo_descripcion: "Reglas Generales",
    capitulo: "IV",
    capitulo_descripcion: "Notificaciones",
    seccion: null,
    seccion_descripcion: null,
  ...
  "32": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Serán nulas las notificaciones que no se hicieren en la forma que establecen las disposiciones precedentes."
  },
  "33": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    capitulo: "V",
    capitulo_descripcion: "Competencia",
    seccion: "Primera",
    seccion_descripcion: "Reglas de Competencia",
    texto_completo: "Son competentes para conocer del juicio de amparo: I. La Suprema Corte de Justicia de la Nación; II. Los tribunales colegiados de circuito; III. Los tribunales colegiados de apelación; IV. Los juzgados de distrito; y V. Los órganos jurisdiccionales de los poderes judiciales de los Estados y de la Ciudad de México, en los casos previstos por esta Ley."
  },
  "34": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "35": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Reglas de Competencia",
    texto_completo: "Los juzgados de distrito y los tribunales colegiados de apelación son competentes para conocer del juicio de amparo indirecto. También lo serán las autoridades del orden común cuando actúen en auxilio de los órganos jurisdiccionales de amparo."
  },
  "36": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "38": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Reglas de Competencia",
    texto_completo: "Es competente para conocer del juicio de amparo indirecto que se promueva contra los actos de un juez o jueza de distrito, otro u otra del mismo distrito y especialización en su caso y, si no lo hubiera, el más cercano o cercana dentro de la jurisdicción del circuito al que pertenezca."
  },
  "39": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Primera",
    seccion_descripcion: "Reglas de Competencia",
    texto_completo: "Cuando se trate de amparos contra actos de autoridades que actúen en auxilio de la justicia federal, no podrá conocer el juez o jueza de distrito que deba avocarse al conocimiento del asunto en que se haya originado el acto reclamado. En este caso, conocerá otro u otra del mismo distrito y especialización, en su caso, y si no lo hubiera, el más cercano o cercana dentro de la jurisdicción del circuito a que pertenezca."
  },
  "40": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "41": {
    ...
    capitulo_descripcion: "Competencia",
    seccion: "Segunda",
    seccion_descripcion: "Conflictos Competenciales",
    texto_completo: "Ningún órgano jurisdiccional puede sostener competencia a su superior."
  },
  "42": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Segunda",
    seccion_descripcion: "Conflictos Competenciales",
    texto_completo: "Luego que se suscite una cuestión de competencia, se suspenderá todo procedimiento con excepción del incidente de suspensión."
  },
  "43": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "46": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Conflictos Competenciales",
    texto_completo: "Cuando un tribunal colegiado de circuito tenga información de que otro conoce de un asunto que a aquél le corresponda, lo requerirá para que le remita los autos. Si el requerido estima no ser competente deberá remitir los autos, dentro de los tres días siguientes a la recepción del requerimiento. Si considera que lo es, en igual plazo hará saber su resolución al requirente, suspenderá el procedimiento y remitirá los autos a la persona titular de la Presidencia de la Suprema Corte de Justicia de la Nación, quien lo turnará a la ministra o ministro ponente que corresponda, para que aquella resuelva lo que proceda dentro del plazo de ocho días. Cuando el tribunal colegiado de circuito que conozca de un juicio o recurso estime carecer de competencia para conocer de ellos, lo declarará así y enviará dentro de los tres días siguientes los autos al órgano jurisdiccional que en su concepto lo sea. Si éste acepta la competencia, se avocará al conocimiento; en caso contrario, dentro de los tres días siguientes comunicará su resolución al órgano que declinó la competencia y remitirá los autos a la Suprema Corte de Justicia de la Nación para que dentro del plazo de ocho días resuelva lo que proceda."
  },
  "47": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "48": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Conflictos Competenciales",
    texto_completo: "Cuando se presente una demanda de amparo ante jueza o juez de distrito o tribunal colegiado de apelación y estimen carecer de competencia, la remitirán de plano, con sus anexos, a la jueza, juez o tribunal competente, sin decidir sobre la admisión ni sobre la suspensión del acto reclamado, salvo que se trate de actos que importen peligro de privación de la vida, ataques a la libertad personal fuera de procedimiento, incomunicación, deportación o expulsión, proscripción o destierro, extradición, desaparición forzada de personas o alguno de los prohibidos por el artículo 22 de la Constitución Política de los Estados Unidos Mexicanos, así como la incorporación forzosa al Ejército, Armada o Fuerza Aérea nacionales. Recibida la demanda y sus anexos por el órgano requerido, éste decidirá de plano, dentro de las cuarenta y ocho horas siguientes, si acepta o no el conocimiento del asunto. Si acepta, comunicará su resolución a la persona requirente, previa notificación de las partes. En caso contrario, devolverá la demanda a la persona requirente, quien deberá resolver dentro de las cuarenta y ocho horas siguientes si insiste o no en declinar su competencia. Si no insiste, se limitará a comunicar su resolución a la persona requerida y se dará por terminado el conflicto competencial. Si insiste en declinar su competencia y la cuestión se plantea entre órganos de la jurisdicción de un mismo tribunal colegiado de circuito, remitirá los autos al tribunal colegiado de circuito de su jurisdicción, el cual dará aviso a la persona requerida para que exponga lo que estime pertinente. Si el conflicto competencial se plantea entre órganos que no sean de la jurisdicción de un mismo tribunal colegiado de circuito, lo resolverá el que ejerza jurisdicción sobre el o la requirente, quien remitirá los autos y dará aviso a la persona requerida para que exponga lo conducente, debiéndose estar a lo que se dispone en el artículo anterior. Recibidos los autos y el oficio relativo, el tribunal colegiado de circuito tramitará el expediente y resolverá dentro de los ocho días siguientes quién debe conocer del juicio; comunicará su resolución a las o los involucrados y remitirá los autos al órgano declarado competente. Admitida la demanda de amparo indirecto ningún órgano jurisdiccional podrá declararse incompetente para conocer del juicio antes de resolver sobre la suspensión definitiva."
  },
  "49": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Segunda",
    seccion_descripcion: "Conflictos Competenciales",
    texto_completo: "Cuando la jueza o el juez de distrito o el tribunal colegiado de apelación ante el cual se hubiese promovido un juicio de amparo tenga información de que otro está conociendo de un juicio diverso promovido por la misma quejosa o quejoso, contra las mismas autoridades y por el mismo acto reclamado, aunque los conceptos de violación sean distintos, lo comunicará de inmediato por oficio a dicho órgano, y anexará la certificación del día y hora de presentación de la demanda, así como, en su caso, del auto dictado como primera actuación en el juicio. Recibido el oficio, el órgano resolverá dentro de las veinticuatro horas siguientes si se trata del mismo asunto y si le corresponde su conocimiento, y comunicará lo anterior al oficiante. Si reconoce la competencia de éste, le remitirá los autos relativos. En caso de conflicto competencial, se estará a lo dispuesto en el artículo 48 de esta Ley. Cuando se resuelva que se trata de un mismo asunto, se continuará el juicio promovido ante la jueza o el juez de distrito o tribunal colegiado de apelación que haya resultado competente y se deberá sobreseer en el otro juicio."
  },
  "50": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "52": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Sólo podrán invocarse como excusas las causas de impedimento que enumera el artículo anterior. Las partes podrán plantear como causa de recusación cualquiera de tales impedimentos."
  },
  "53": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El que se excuse deberá, en su caso, proveer sobre la suspensión excepto cuando aduzca tener interés personal en el asunto, salvo cuando proceda legalmente la suspensión de oficio. El que deba sustituirlo resolverá lo que corresponda, en tanto se califica la causa de impedimento."
  },
  "54": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Conocerán de las excusas y recusaciones: I. El pleno de la Suprema Corte de Justicia de la Nación en los asuntos de su competencia; II. Derogada; III. Los tribunales colegiados de circuito: a) De una de sus magistradas o magistrados; b) De dos o más magistradas o magistrados de otro tribunal colegiado de circuito; c) De las juezas o jueces de distrito, que se encuentren en su circuito; IV. Los tribunales colegiados de apelación: a) De una de sus magistradas o magistrados; b) De dos o más magistradas o magistrados de otro tribunal colegiado de apelación."
  },
  "55": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Las ministras y los ministros de la Suprema Corte de Justicia de la Nación manifestarán estar impedidos ante el tribunal pleno. Las magistradas o los magistrados de circuito y las juezas o los jueces de distrito manifestarán su impedimento y lo comunicarán al tribunal que corresponda. Las excusas se calificarán de plano."
  },
  "56": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Cuando una de las ministras o ministros se manifieste impedido en asuntos del conocimiento del Pleno, las ministras y ministros restantes calificarán la excusa. Si la admiten, éstos continuarán en el conocimiento del asunto; en caso de empate, quien presida tendrá voto de calidad."
  },
  "57": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Cuando uno o una de los integrantes de un tribunal colegiado de circuito o de un tribunal colegiado de apelación, se excuse o sea recusado, los y las restantes resolverán lo conducente. En caso de empate, la resolución corresponderá al tribunal colegiado de circuito siguiente en orden del mismo circuito y especialidad y, de no haberlos, al del circuito más cercano. El mismo procedimiento se seguirá tratándose de empate en tribunales colegiados de apelación. Cuando la excusa o recusación se refiera a más de un magistrado o magistrada, la resolución se hará en términos del párrafo anterior. Si sólo es fundada la excusa o recusación de uno de los magistrados, el asunto se devolverá al tribunal de origen para que resuelva. Si fueren dos o más las magistradas o magistrados que resulten impedidos, el propio tribunal que así lo decidió resolverá el asunto principal."
  },
  "58": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Cuando se declare impedida a una jueza o un juez de distrito, conocerá del asunto otra u otro adscrito, al mismo circuito, según corresponda y, en su caso, especialización; en su defecto, conocerá el más próximo perteneciente al mismo circuito."
  },
  "59": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el escrito de recusación deberán manifestarse, bajo protesta de decir verdad, los hechos que la fundamentan y exhibirse en billete de depósito la cantidad correspondiente al monto máximo de la multa que pudiera imponerse en caso de declararse infundada. De no cumplirse estos requisitos la recusación se desechará de plano, salvo que, por lo que hace al último de ellos, se alegue insolvencia. En este caso, el órgano jurisdiccional la calificará y podrá exigir garantía por el importe del mínimo de la multa o exentar de su exhibición. Asimismo, el órgano jurisdiccional desechará de plano la recusación, cuando: I. Se advierta que existan elementos suficientes que demuestren que su promoción se haya dirigido a entorpecer o dilatar el procedimiento en cuestión, o II. Sea presentada para que algún Ministro o Ministra, Magistrado o Magistrada se abstenga de conocer de cuestiones accesorias o diversas al fondo de la controversia."
  },
  "60": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "65": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El sobreseimiento no prejuzga sobre la constitucionalidad o legalidad del acto reclamado, ni sobre la responsabilidad de la autoridad responsable al ordenarlo o ejecutarlo y solo podrá decretarse cuando no exista duda de su actualización."
  },
  "66": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    capitulo: "IX",
    capitulo_descripcion: "Incidentes",
    seccion: null,
    seccion_descripcion: null,
  ...
  "69": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Nulidad de Notificaciones",
    texto_completo: "Declarada la nulidad, se repondrá el procedimiento a partir de la actuación anulada."
  },
  "70": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    capitulo_descripcion: "Incidentes",
    seccion: "Segunda",
    seccion_descripcion: "Reposición de Constancias de Autos",
  ...
  "77": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Los efectos de la concesión del amparo serán: I. Cuando el acto reclamado sea de carácter positivo se restituirá a la persona quejosa en el pleno goce del derecho violado, restableciendo las cosas al estado que guardaban antes de la violación, y II. Cuando el acto reclamado sea de carácter negativo o implique una omisión, obligar a la autoridad responsable a respetar el derecho de que se trate y a cumplir lo que el mismo exija. En el último considerando de la sentencia que conceda el amparo, la persona juzgadora deberá determinar con precisión los efectos del mismo, especificando las medidas que las autoridades o particulares deban adoptar para asegurar su estricto cumplimiento y la restitución de la persona quejosa en el goce del derecho. En asuntos del orden penal en que se reclame una orden de aprehensión o autos que establezcan providencias precautorias o impongan medidas cautelares restrictivas de la libertad con motivo de delitos que la ley no considere como graves o respecto de los cuales no proceda la prisión preventiva oficiosa conforme la legislación procedimental aplicable, la sentencia que conceda el amparo surtirá efectos inmediatos, sin perjuicio de que pueda ser revocada mediante el recurso de revisión; salvo que se reclame el auto por el que se resuelva la situación jurídica de la persona quejosa en el sentido de sujetarlo a proceso penal, en términos de la legislación procesal aplicable, y el amparo se conceda por vicios formales. En caso de que el efecto de la sentencia sea la libertad de la persona quejosa, ésta se decretará bajo las medidas de aseguramiento que el órgano jurisdiccional estime necesarias, a fin de que la persona quejosa no evada la acción de la justicia. En todo caso, la sentencia surtirá sus efectos, cuando se declare ejecutoriada o cause estado por ministerio de ley."
  },
  "78": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "84": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "Son competentes los tribunales colegiados de circuito para conocer del recurso de revisión en los casos no previstos en el artículo anterior. Las sentencias que dicten en estos casos no admitirán recurso alguno."
  },
  "85": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "86": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "El recurso de revisión se interpondrá en el plazo de diez días por conducto del órgano jurisdiccional que haya dictado la resolución recurrida. La interposición del recurso por conducto de órgano diferente al señalado en el párrafo anterior no interrumpirá el plazo de presentación."
  },
  "87": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "Las autoridades responsables sólo podrán interponer el recurso de revisión contra sentencias que afecten directamente el acto reclamado de cada una de ellas; tratándose de amparo contra normas generales podrán hacerlo los titulares de los órganos del Estado a los que se encomiende su emisión o promulgación. Las autoridades judiciales o jurisdiccionales carecen de legitimación para recurrir las sentencias que declaren la inconstitucionalidad del acto reclamado, cuando éste se hubiera emitido en ejercicio de la potestad jurisdiccional."
  },
  "88": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "El recurso de revisión se interpondrá por escrito en el que se expresarán los agravios que cause la resolución impugnada. Si el recurso se interpone en contra de una resolución dictada en amparo directo, el o la recurrente deberá transcribir textualmente la parte de la sentencia que contenga un pronunciamiento sobre constitucionalidad de normas generales o establezca la interpretación directa de un precepto de la Constitución Política de los Estados Unidos Mexicanos, o la parte del concepto de violación respectivo cuyo análisis se hubiese omitido en la sentencia. En caso de que el escrito de expresión de agravios se presente en forma impresa, el o la recurrente deberá exhibir una copia del mismo para el expediente y una para cada una de las partes. Esta exigencia no será necesaria en los casos que el recurso se presente en forma electrónica. Cuando no se haga la transcripción a que se refiere el párrafo primero o no se exhiban las copias a que se refiere el párrafo anterior, se requerirá al recurrente para que en el plazo de tres días lo haga; si no lo hiciere se tendrá por no interpuesto el recurso, salvo que se afecte al o la recurrente por actos restrictivos de la libertad, se trate de menores de edad o de incapaces, o se afecten derechos agrarios de núcleos de población ejidal o comunal o de personas ejidatarias o comuneras en lo individual, o quienes por sus condiciones de pobreza o marginación se encuentren en clara desventaja social para emprender un juicio, en los que el órgano jurisdiccional expedirá las copias correspondientes."
  },
  "89": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "91": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "La persona titular de la presidencia del órgano jurisdiccional, según corresponda, dentro de los tres siguientes días a su recepción calificará la procedencia del recurso y lo admitirá o desechará. Cuando se trate del recurso de revisión en amparo directo no procederá ningún medio de impugnación en contra del auto que deseche el recurso."
  },
  "92": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "Notificadas las partes del auto de admisión, transcurrido el plazo para adherirse a la revisión y, en su caso, tramitada ésta, se turnará de inmediato el expediente al ministro, ministra, magistrado o magistrada que corresponda. La resolución deberá dictarse dentro del plazo máximo de noventa días."
  },
  "93": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "94": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "En la revisión adhesiva el estudio de los agravios podrá hacerse en forma conjunta o separada, atendiendo a la prelación lógica que establece el artículo anterior."
  },
  "95": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Primera",
    seccion_descripcion: "Recurso de Revisión",
    texto_completo: "Cuando en la revisión concurran materias que sean de la competencia de la Suprema Corte de Justicia de la Nación y de un tribunal colegiado de circuito, se estará a lo establecido en los acuerdos generales del Pleno de la propia Corte."
  },
  "96": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "98": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Recurso de Queja",
    texto_completo: "El plazo para la interposición del recurso de queja es de cinco días, con las excepciones siguientes: I. De dos días hábiles, cuando se trate de suspensión de plano o provisional; y II. En cualquier tiempo, cuando se omita tramitar la demanda de amparo."
  },
  "99": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "100": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Recurso de Queja",
    texto_completo: "En el escrito de queja se expresarán los agravios que cause la resolución recurrida. En caso de que el escrito de expresión de agravios se presente en forma impresa, el o la recurrente deberá exhibir una copia del mismo para el expediente y una para cada una de las partes, señalando las constancias que en copia certificada deberán remitirse al órgano jurisdiccional que deba resolver el recurso. Esta exigencia no será necesaria en los casos que el recurso se presente en forma electrónica. Cuando no se exhiban las copias a que se refiere el párrafo anterior se requerirá al o la recurrente para que en el plazo de tres días lo haga; si no lo hiciere, se tendrá por no interpuesto el recurso, salvo que se trate de actos restrictivos de la libertad o que afecten intereses de menores de edad o incapaces o de personas trabajadoras o derechos agrarios de núcleos de población ejidal o comunal o de personas ejidatarias o comuneras en lo individual, o quienes por sus condiciones de pobreza o marginación se encuentren en clara desventaja social para emprender un juicio, en los que el órgano jurisdiccional expedirá las copias correspondientes."
  },
  "101": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "104": {
    ...
    capitulo_descripcion: "Medios de Impugnación",
    seccion: "Tercera",
    seccion_descripcion: "Recurso de Reclamación",
    texto_completo: "El recurso de reclamación es procedente contra los acuerdos de trámite dictados por la persona titular de la Presidencia de la Suprema Corte de Justicia de la Nación o por las personas titulares de la presidencia de los tribunales colegiados de circuito. Dicho recurso se podrá interponer por cualquiera de las partes, por escrito, en el que se expresan agravios, dentro del término de tres días siguientes al en que surta sus efectos la notificación de la resolución impugnada. En contra del acuerdo que deseche el recurso de revisión en amparo directo no procede medio de impugnación alguno."
  },
  "105": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Recurso de Reclamación",
    texto_completo: "El órgano jurisdiccional que deba conocer del asunto resolverá en un plazo máximo de diez días; la persona ponente será un ministro o ministra o magistrado o magistrada distinta a la persona titular de su presidencia."
  },
  "106": {
    titulo: "PRIMERO",
    titulo_descripcion: "Reglas Generales",
  ...
  "109": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Procedencia y Demanda",
    texto_completo: "Cuando se promueva el amparo en los términos del artículo 15 de esta Ley, bastará para que se dé trámite a la demanda, que se exprese: I. El acto reclamado; II. La autoridad que lo hubiere ordenado, si fuere posible; III. La autoridad que ejecute o trate de ejecutar el acto; y IV. En su caso, el lugar en que se encuentre la persona quejosa. En estos supuestos, la demanda podrá formularse por escrito, por comparecencia o por medios electrónicos. En este último caso no se requerirá de firma electrónica."
  },
  "110": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "112": {
    ...
    capitulo_descripcion: "El Amparo Indirecto",
    seccion: "Segunda",
    seccion_descripcion: "Substanciación",
    texto_completo: "Dentro del plazo de veinticuatro horas contado desde que la demanda fue presentada, o en su caso turnada, el órgano jurisdiccional deberá resolver si desecha, previene o admite. En el supuesto de los artículos 15 y 20 de esta Ley deberá proveerse de inmediato."
  },
  "113": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Segunda",
    seccion_descripcion: "Substanciación",
    texto_completo: "El órgano jurisdiccional que conozca del juicio de amparo indirecto examinará el escrito de demanda y si existiera causa manifiesta e indudable de improcedencia la desechará de plano."
  },
  "114": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "121": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Substanciación",
    texto_completo: "A fin de que las partes puedan rendir sus pruebas, las personas servidoras públicas tienen la obligación de expedir con toda oportunidad, las copias o documentos que aquellas les hubieren solicitado. Si no lo hacen, la parte interesada una vez que acredite haber hecho la petición, solicitará al órgano jurisdiccional que requiera a las omisas y difiera la audiencia, lo que se acordará siempre que la solicitud se hubiere hecho cinco días hábiles antes del señalado para su celebración, sin contar el de la solicitud ni el señalado para la propia audiencia. El órgano jurisdiccional hará el requerimiento de que se le envíen directamente los documentos o copias dentro de un plazo que no exceda de diez días. Este plazo no podrá ampliarse con motivo del diferimiento de la audiencia constitucional, salvo que se trate de probar o desvirtuar hechos que no hayan podido ser conocidos por las partes con la oportunidad legal suficiente para ofrecerlas en el plazo referido, por causas no imputables a su descuido o negligencia dentro del procedimiento. En estos casos, el plazo para el ofrecimiento de tales pruebas será el señalado para la audiencia constitucional, tomando como indicador la nueva fecha señalada para la audiencia. Si a pesar del requerimiento no se le envían oportunamente los documentos o copias, el órgano jurisdiccional, a petición de parte, podrá diferir la audiencia hasta en tanto se envíen; hará uso de los medios de apremio y agotados éstos, si persiste el incumplimiento denunciará los hechos al o la Ministerio Público de la Federación. Si se trata de actuaciones concluidas, podrán pedirse originales a instancia de cualquiera de las partes."
  },
  "122": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "125": {
    ...
    capitulo_descripcion: "El Amparo Indirecto",
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "La suspensión del acto reclamado se decretará de oficio o a petición de la persona quejosa."
  },
  "126": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "127": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "El incidente de suspensión se abrirá de oficio y se sujetará en lo conducente al trámite previsto para la suspensión a instancia de parte, en los siguientes casos: I. Extradición; y II. Siempre que se trate de algún acto que, si llegare a consumarse, haría físicamente imposible restituir a la persona quejosa en el goce del derecho reclamado."
  },
  "128": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "130": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "La suspensión se podrá pedir en cualquier tiempo mientras no se dicte sentencia ejecutoria."
  },
  "131": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "133": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "La suspensión, en su caso, quedará sin efecto si la o el tercero otorga contragarantía para restituir las cosas al estado que guardaban antes de la violación reclamada y pagar los daños y perjuicios que sobrevengan a la persona quejosa, en el caso de que se le conceda el amparo. No se admitirá la contragarantía cuando de ejecutarse el acto reclamado quede sin materia el juicio de amparo o cuando resulte en extremo difícil restituir las cosas al estado que guardaban antes de la violación. Cuando puedan afectarse derechos que no sean estimables en dinero, el órgano jurisdiccional fijará discrecionalmente el importe de la contragarantía."
  },
  "134": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "La contragarantía que ofrezca la o el tercero conforme al artículo anterior deberá también cubrir el costo de la garantía que hubiese otorgado la persona quejosa, que comprenderá: I. Los gastos o primas pagados, conforme a la ley, a la empresa legalmente autorizada que haya otorgado la garantía; II. Los gastos legales de la escritura respectiva y su registro, así como los de la cancelación y su registro, cuando la persona quejosa hubiere otorgado garantía hipotecaria, y III. Los gastos legales acreditados para constituir el depósito."
  },
  "135": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "137": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Las personas morales públicas y las oficiales que conforman las Administraciones Públicas Federal, Estatal y Municipal, los fondos, mandatos o análogos, o cualquier otro ente público, independientemente de su origen y estructura, estarán exentos de otorgar las garantías que esta Ley exige."
  },
  "138": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Promovida la suspensión del acto reclamado, el órgano jurisdiccional deberá analizar los elementos que obren en autos para determinar si se actualizan los requisitos previstos en el artículo 128 de esta Ley, atendiendo a la naturaleza provisional e inmediata de la medida cautelar. Concluida dicha valoración, la persona juzgadora deberá emitir un auto en el que: I. Concederá o negará la suspensión provisional; en el primer caso, fijará los requisitos y efectos de la medida; en el segundo caso, la autoridad responsable podrá ejecutar el acto reclamado; II. Señalará fecha y hora para la celebración de la audiencia incidental que deberá efectuarse dentro del plazo de cinco días; y III. Solicitará informe previo a las autoridades responsables, que deberán rendirlo dentro del plazo de cuarenta y ocho horas, para lo cual en la notificación correspondiente se les acompañará copia de la demanda y anexos que estime pertinentes."
  },
  "139": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "145": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Cuando apareciere debidamente probado que ya se resolvió sobre la suspensión en otro juicio de amparo, promovido con anterioridad por la misma persona quejosa o por otra persona en su nombre o representación, contra el mismo acto reclamado y contra las propias autoridades, se declarará sin materia el incidente de suspensión."
  },
  "146": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "149": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Cuando por mandato expreso de una norma general o de alguna autoridad, un particular tuviere o debiera tener intervención en la ejecución, efectos o consecuencias del acto reclamado, el efecto de la suspensión será que la autoridad responsable ordene a dicho particular la inmediata paralización de la ejecución, efectos o consecuencias de dicho acto o, en su caso, que tome las medidas pertinentes para el cumplimiento estricto de lo establecido en la resolución suspensional."
  },
  "150": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "152": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Tratándose de la última resolución que se dicte en el procedimiento de ejecución de un laudo en materia laboral la suspensión se concederá en los casos en que, a juicio de la persona titular de la presidencia del tribunal respectivo, no se ponga a la parte que obtuvo, si es la obrera, en peligro de no poder subsistir mientras se resuelve el juicio de amparo, en los cuales sólo se suspenderá la ejecución en cuanto exceda de lo necesario para asegurar tal subsistencia."
  },
  "153": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "La resolución en que se niegue la suspensión definitiva deja expedita la facultad de la autoridad responsable para la ejecución del acto reclamado, aunque se interponga recurso de revisión; pero si con motivo del recurso se concede, sus efectos se retrotraerán a la fecha del auto o interlocutoria correspondiente, siempre que la naturaleza del acto lo permita."
  },
  "154": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "155": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Cuando se interponga recurso contra resoluciones dictadas en el incidente de suspensión, se remitirá el original al tribunal colegiado de circuito competente y se dejará el duplicado en poder del órgano jurisdiccional que conozca del amparo, sin perjuicio de que se siga actuando en el duplicado."
  },
  "156": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "157": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "En lo conducente, se aplicará al auto que resuelve sobre la suspensión provisional lo dispuesto para la resolución que decide sobre la suspensión definitiva."
  },
  "158": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Para la ejecución y cumplimiento del auto de suspensión se observarán las disposiciones relativas al Título Quinto de esta Ley. En caso de incumplimiento, cuando la naturaleza del acto lo permita, el órgano jurisdiccional de amparo podrá hacer cumplir la resolución suspensional o podrá tomar las medidas para el cumplimiento."
  },
  "159": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "En los lugares donde no resida juez o jueza de distrito y especialmente cuando se trate de actos que importen peligro de privación de la vida, ataques a la libertad personal fuera de procedimiento, incomunicación, deportación o expulsión, proscripción o destierro, extradición, desaparición forzada de personas o alguno de los prohibidos por el artículo 22 de la Constitución Política de los Estados Unidos Mexicanos, así como la incorporación forzosa al Ejército, Armada o Fuerza Aérea nacionales, el juez o jueza de primera instancia dentro de cuya jurisdicción radique la autoridad que ejecute o trate de ejecutar el acto reclamado, deberá recibir la demanda de amparo y acordar de plano sobre la suspensión de oficio conforme a las siguientes reglas: I. Formará por duplicado un expediente que contenga la demanda de amparo y sus anexos, el acuerdo que decrete la suspensión de oficio y el señalamiento preciso de la resolución que se mande suspender; las constancias de notificación y las determinaciones que dicte para hacer cumplir su resolución; II. Ordenará a la autoridad responsable que mantenga las cosas en el estado en que se encuentren o que, en su caso, proceda inmediatamente a poner en libertad o a disposición del o la Ministerio Público a la persona quejosa y que rinda al juez o jueza de distrito el informe previo, y III. Remitirá de inmediato el original de las actuaciones al juez o jueza de distrito competente y conservará el duplicado para vigilar el cumplimiento de sus resoluciones, hasta en tanto el juez o jueza de distrito provea lo conducente, con plena jurisdicción. En caso de la probable comisión del delito de desaparición forzada, el juez o jueza de primera instancia procederá conforme lo establecido por el artículo 15 de esta Ley. Cuando el amparo se promueva contra actos de un juez o jueza de primera instancia y no haya otro en el lugar, o cuando se impugnen actos de otras autoridades y aquél no pueda ser habido, la demanda de amparo podrá presentarse ante cualquiera de los órganos judiciales que ejerzan jurisdicción en el mismo lugar, siempre que en él resida la autoridad ejecutora o, en su defecto, ante el órgano jurisdiccional más próximo."
  },
  "160": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Cuando el acto reclamado sea la orden de deportación, expulsión o extradición, la suspensión tiene por efecto que no se ejecute y la persona interesada quede en el lugar donde se encuentre a disposición del órgano jurisdiccional de amparo, sólo en lo que se refiere a su libertad personal."
  },
  "161": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Cuando el acto reclamado consista en la orden de traslado de la persona quejosa de un centro penitenciario a otro, la suspensión, si procede, tendrá por efecto que éste no se lleve a cabo."
  },
  "162": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "167": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "La libertad otorgada a la persona quejosa con motivo de una resolución suspensional podrá ser revocada cuando ésta incumpla con cualquiera de las obligaciones establecidas por el órgano jurisdiccional de amparo o derivadas del procedimiento penal respectivo."
  },
  "168": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Suspensión del Acto Reclamado",
    texto_completo: "Para la procedencia de la suspensión contra actos derivados de un procedimiento penal que afecten la libertad personal en los términos del artículo 166, fracción II, el órgano jurisdiccional de amparo deberá exigir a la persona quejosa que, dentro de los cinco días siguientes a la notificación de la determinación de la suspensión, exhiba garantía, sin perjuicio de otras medidas de aseguramiento que estime convenientes. Para fijar el monto de la garantía se tomará en cuenta: I. La naturaleza, modalidades y características del delito que se le impute; II. Las características personales y situación económica de la persona quejosa, y III. La posibilidad de que se sustraiga a la acción de la justicia. No se exigirá garantía cuando la suspensión únicamente tenga los efectos a que se refiere el artículo 163 de esta Ley. El incumplimiento de cualesquiera de las condiciones fijadas por la persona juzgadora dará lugar a la revocación de la suspensión."
  },
  "169": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "170": {
    ...
    titulo_descripcion: "De los Procedimientos de Amparo",
    capitulo: "II",
    capitulo_descripcion: "El Amparo Directo",
    seccion: "Primera",
    seccion_descripcion: "Procedencia",
    texto_completo: "El juicio de amparo directo procede: I. Contra sentencias definitivas, laudos y resoluciones que pongan fin al juicio, dictadas por tribunales judiciales, administrativos, agrarios o del trabajo, ya sea que la violación se cometa en ellos, o que cometida durante el procedimiento, afecte las defensas de la persona quejosa trascendiendo al resultado del fallo. Se entenderá por sentencias definitivas o laudos, los que decidan el juicio en lo principal; por resoluciones que pongan fin al juicio, las que sin decidirlo en lo principal lo den por concluido. En materia penal, las sentencias condenatorias, absolutorias y de sobreseimiento, podrán ser impugnadas por la víctima u persona ofendida del delito. Para la procedencia del juicio deberán agotarse previamente los recursos ordinarios que se establezcan en la ley de la materia, por virtud de los cuales aquellas sentencias definitivas o laudos y resoluciones puedan ser modificados o revocados, salvo el caso en que la ley permita la renuncia de los recursos. Cuando dentro del juicio surjan cuestiones sobre constitucionalidad de normas generales que sean de reparación posible por no afectar derechos sustantivos ni constituir violaciones procesales relevantes, sólo podrán hacerse valer en el amparo directo que proceda contra la resolución definitiva. Para efectos de esta Ley, el juicio se inicia con la presentación de la demanda. En materia penal el proceso comienza con la audiencia inicial ante el Juez o Jueza de control; II. Contra sentencias definitivas y resoluciones que pongan fin al juicio dictadas por tribunales de lo contencioso administrativo cuando éstas sean favorables a la persona quejosa, para el único efecto de hacer valer conceptos de violación en contra de las normas generales aplicadas. En estos casos, el juicio se tramitará únicamente si la autoridad interpone y se admite el recurso de revisión en materia contencioso administrativa previsto por el artículo 104 de la Constitución Política de los Estados Unidos Mexicanos. El tribunal colegiado de circuito resolverá primero lo relativo al recurso de revisión contencioso administrativa, y únicamente en el caso de que éste sea considerado procedente y fundado, se avocará al estudio de las cuestiones de constitucionalidad planteadas en el juicio de amparo."
  },
  "171": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "173": {
    ...
    seccion: "Primera",
    seccion_descripcion: "Procedencia",
    texto_completo: "En los juicios del orden penal se considerarán violadas las leyes del procedimiento con trascendencia a las defensas de la persona quejosa, cuando: Apartado A. Sistema de Justicia Penal Mixto: I. No se le haga saber el motivo del procedimiento o la causa de la acusación y el nombre del acusador o acusadora particular si lo hubiere; II. No se le permita nombrar defensor o defensora, en la forma que determine la ley; cuando no se le haga saber el nombre del o la adscrita al juzgado o tribunal que conozca de la causa, si no tuviere quien la defienda; cuando no se le facilite la manera de hacer saber su nombramiento al defensor o defensora designada; cuando se le impida comunicarse con él o que dicho defensor lo asista en alguna diligencia del proceso, o cuando, habiéndose negado a nombrar defensor o defensora, sin manifestar expresamente que se defenderá por sí misma, no se le nombre de oficio; III. Habiéndolo solicitado no se le caree, en presencia del juez o jueza, en los supuestos y términos que establezca la ley; IV. El juez o jueza no actúe con secretario o secretaria o con testigos de asistencia, o cuando se practiquen diligencias en forma distinta de la prevenida por la ley; V. No se le cite para las diligencias que tenga derecho a presenciar o cuando sea citado en forma ilegal, siempre que por ello no comparezca; cuando no se le admita en el acto de la diligencia, o cuando se le coarten en ella los derechos que la ley le otorga; VI. No se respete a la persona imputada el derecho a declarar o a guardar silencio, la declaración de la persona imputada se obtenga mediante incomunicación, intimidación, tortura o sin presencia de su defensor o defensora o cuando el ejercicio del derecho a guardar silencio se utilice en su perjuicio; VII. No se le reciban las pruebas que ofrezca legalmente, o cuando no se reciban con arreglo a derecho; VIII. Se le desechen los recursos que tuviere conforme a la ley, respecto de providencias que afecten partes substanciales del procedimiento y produzcan indefensión de acuerdo con las demás fracciones de este mismo artículo; IX. No se le suministren los datos que necesite para su defensa; X. Se celebre la audiencia de derecho sin la asistencia del o la Agente del Ministerio Público a quien corresponda formular la requisitoria, sin la del juez o jueza que deba fallar o la del secretario o secretaria o testigos de asistencia que deban autorizar el acto, así como el defensor o defensora; XI. La sentencia se funde en la confesión del reo o la rea, si estuvo incomunicada antes de otorgarla, o si se obtuvo su declaración por medio de intimidación, tortura o de cualquiera otra coacción; XII. La sentencia se funde en alguna diligencia cuya nulidad establezca la ley expresamente; XIII. Seguido el proceso por el delito determinado en el auto de formal prisión, la persona quejosa fuere sentenciada por diverso delito. No se considerará que el delito es diverso cuando el que se exprese en la sentencia solo difiera en grado del que haya sido materia del proceso, ni cuando se refiera a los mismos hechos materiales que fueron objeto de la averiguación siempre que, en este último caso el o la Ministerio Público haya formulado conclusiones acusatorias cambiando la clasificación del delito hecha en el auto de formal prisión o de sujeción a proceso, y que la persona quejosa hubiese sido oída en defensa sobre la nueva clasificación, durante el juicio propiamente tal, y XIV. En los demás casos análogos a los de las fracciones anteriores, a juicio del órgano jurisdiccional de amparo. Apartado B. Sistema de Justicia Penal Acusatorio y Oral: I. Se desarrolle cualquier audiencia sin la presencia del órgano jurisdiccional actuante o se practique diligencias en forma distinta a la prevenida por la ley; II. El desahogo de pruebas se realice por una persona distinta a la autoridad judicial que deba intervenir; III. Intervenga en el juicio el órgano jurisdiccional que haya conocido del caso previamente; IV. La presentación de argumentos y pruebas en el juicio no se realice de manera pública, contradictoria y oral, salvo las excepciones previstas por la legislación procedimental aplicable; V. La oportunidad para sostener la acusación o la defensa no se realice en igualdad de condiciones; VI. No se respete a la persona imputada el derecho a declarar o guardar silencio, la declaración de la persona imputada se obtenga mediante incomunicación, intimidación, tortura o sin presencia de su defensor o defensora, o cuando el ejercicio del derecho a guardar silencio se utilice en su perjuicio; VII. El Órgano jurisdiccional reciba a una de las partes para tratar el asunto sujeto a proceso sin la presencia de la otra, salvo las excepciones previstas por la legislación procedimental aplicable; VIII. La persona imputada no sea informada, desde el momento de su detención en su comparecencia ante el o la Ministerio Público o ante el órgano jurisdiccional, de los hechos que se le imputan y los derechos que le asisten; IX. No se le haga saber o se le niegue a la persona imputada extranjera, el derecho a recibir asistencia consular de las embajadas o consulados del país respecto del que sea nacional, salvo que haya declinado fehacientemente a este derecho; X. No se reciban a la persona imputada los medios de prueba o pruebas pertinentes que ofrezca o no se reciban con arreglo a derecho, no se le conceda el tiempo para el ofrecimiento de pruebas o no se le auxilie para obtener la comparecencia de las personas de quienes ofrezca su testimonio en los términos señalados por la ley; XI. La persona imputada no sea juzgada en audiencia pública por un juez o jueza o tribunal, salvo cuando se trate de los casos de excepción precisados por las disposiciones aplicables; XII. No se faciliten a la persona imputada todos los datos que solicite para su defensa y que consten en el procedimiento o se restrinja a la persona imputada y a la defensa el acceso a los registros de investigación cuando la primera esté detenida o se pretenda recibirle declaración o entrevistarla; XIII. No se respete a la persona imputada el derecho de contar con una defensa adecuada por abogado o abogada que elija libremente desde el momento de su detención, o en caso de que no quiera o no pueda hacerlo, el juez o jueza no le nombre un defensor o defensora pública, o cuando se impida, restrinja o intervenga la comunicación con su defensor o defensora; cuando la persona imputada sea indígena no se le proporcione la asistencia de un defensor o defensora que tenga conocimiento de su lengua y cultura, así como cuando el defensor o defensora no comparezca a todos los actos del proceso; XIV. En caso de que la persona imputada no hable o entienda suficientemente el idioma español o sea sorda o muda y no se le proporcione la asistencia de un o una intérprete que le permita acceder plenamente a la jurisdicción del Estado, o que tratándose de personas indígenas no se les proporcione un o una intérprete que tenga conocimiento de su lengua y cultura; XV. Debiendo ser juzgado por una autoridad judicial, no se integre en los términos previstos en la ley o se le juzgue por otro tribunal; XVI. No se permite interponer los recursos en los términos que la ley prevea respecto de las providencias que afecten partes sustanciales del procedimiento que produzca indefensión; XVII. No se hayan respetado los derechos de la persona víctima y ofendida en términos de la legislación aplicable; XVIII. Cuando seguido el proceso por un delito, la persona quejosa haya sido sentenciada por un ilícito diverso a los mismos hechos materiales que fueron objeto de la investigación, sin que hubiese sido oído en defensa sobre la nueva clasificación, en términos de la legislación procedimental aplicable. No se considerará que el delito es diverso cuando el que se exprese en la sentencia sólo difiera en grado del que haya sido materia del proceso, o bien sea el resultado de la reclasificación jurídica del delito en términos del Código Nacional de Procedimientos Penales; XIX. Se trate de casos análogos a las fracciones anteriores a juicio del Órgano jurisdiccional de amparo."
  },
  "174": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "176": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Demanda",
    texto_completo: "La demanda de amparo deberá presentarse por conducto de la autoridad responsable, con copia para cada una de las partes. La presentación de la demanda ante autoridad distinta de la responsable no interrumpe los plazos que para su promoción establece esta Ley."
  },
  "177": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "178": {
    ...
    seccion: "Segunda",
    seccion_descripcion: "Demanda",
    texto_completo: "Dentro del plazo de cinco días contados a partir del siguiente al de presentación de la demanda, la autoridad responsable que emitió el acto reclamado deberá: I. Certificar al pie de la demanda, la fecha de notificación a la persona quejosa de la resolución reclamada, la de su presentación y los días inhábiles que mediaron entre ambas fechas. Si no consta en autos la fecha de notificación, la autoridad responsable dará cumplimiento a lo dispuesto en este artículo, sin perjuicio de que dentro de las veinticuatro horas siguientes a la en que obre en su poder la constancia de notificación respectiva proporcione la información correspondiente al órgano jurisdiccional competente; II. Correr traslado a la o el tercero interesado, en el último domicilio que haya designado para oír notificaciones en los autos del juicio de origen o en el que señale la persona quejosa, y III. Rendir el informe con justificación acompañando la demanda de amparo, los autos del juicio de origen con sus anexos y la constancia de traslado a las partes. Deberá dejar copia certificada de las actuaciones que estime necesarias para la ejecución de la resolución reclamada o para proveer respecto de la suspensión. En el sistema procesal penal acusatorio, se acompañará un índice cronológico del desahogo de la audiencia en la que se haya dictado el acto reclamado, en el que se indique el orden de intervención de cada una de las partes."
  },
  "179": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Substanciación",
    texto_completo: "La persona titular de la presidencia del tribunal colegiado de circuito deberá resolver en el plazo de tres días si admite la demanda, previene a la persona quejosa para su regularización, o la desecha por encontrar motivo manifiesto e indudable de improcedencia."
  },
  "180": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "181": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Substanciación",
    texto_completo: "Si la persona titular de la presidencia del tribunal colegiado de circuito no encuentra motivo de improcedencia o defecto en el escrito de demanda, o si este último fuera subsanado, la admitirá y mandará notificar a las partes el acuerdo relativo dentro de los cinco días siguientes a su pronunciamiento, para que en el plazo de quince días presenten sus alegatos o promuevan amparo adhesivo."
  },
  "182": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "183": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Substanciación",
    texto_completo: "Transcurridos los plazos a que se refiere el artículo 181, dentro de los tres días siguientes la persona titular de la presidencia del tribunal colegiado turnará el expediente a la persona magistrada ponente que corresponda, a efecto de que formule el proyecto de resolución, dentro de los noventa días siguientes. El auto de turno hace las veces de citación para sentencia."
  },
  "184": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "187": {
    ...
    seccion: "Tercera",
    seccion_descripcion: "Substanciación",
    texto_completo: "Si no fuera aprobado el proyecto, pero el magistrado o magistrada ponente aceptare las adiciones o reformas propuestas en la sesión, procederá a redactar la sentencia con base en los términos de la discusión. Si el voto de la mayoría de los magistrados o magistradas fuera en sentido distinto al del proyecto, uno de ellos o ellas redactará la sentencia. En ambos casos el plazo para redactar la sentencia será de diez días, debiendo quedar en autos constancia del proyecto original."
  },
  "188": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Substanciación",
    texto_completo: "Las sentencias del tribunal deberán ser firmadas por todos sus integrantes y por el secretario de acuerdos. Cuando por cualquier motivo cambiare el personal del tribunal que haya dictado una ejecutoria conforme a los artículos anteriores, antes de que haya podido ser firmada por los magistrados o magistradas que la hubiesen dictado, si fue aprobado el proyecto de la magistrada o magistrado relator, la sentencia será autorizada válidamente por los magistrados o magistradas que integran aquél, haciéndose constar las circunstancias que hubiesen concurrido. Firmada la sentencia se notificará por lista a las partes. En los casos en que proceda el recurso de revisión la notificación a las partes se hará en forma personal. Para los efectos del párrafo anterior, la autoridad responsable solo será notificada al proveerse la remisión de los autos a la Suprema Corte de Justicia de la Nación o haya transcurrido el plazo para interponer el recurso."
  },
  "189": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
    ...
    seccion: "Tercera",
    seccion_descripcion: "Substanciación",
    texto_completo: "El órgano jurisdiccional de amparo procederá al estudio de los conceptos de violación atendiendo a su prelación lógica y privilegiando en todo caso el estudio de aquellos que, de resultar fundados, redunden en el mayor beneficio para la persona quejosa. En todas las materias, se privilegiará el estudio de los conceptos de violación de fondo por encima de los de procedimiento y forma, a menos que invertir el orden redunde en un mayor beneficio para la persona quejosa. En los asuntos del orden penal, cuando se desprendan violaciones de fondo de las cuales pudiera derivarse la extinción de la acción persecutoria o la inocencia de la persona quejosa, se le dará preferencia al estudio de aquéllas aún de oficio."
  },
  "190": {
    titulo: "SEGUNDO",
    titulo_descripcion: "De los Procedimientos de Amparo",
  ...
  "194": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Se entiende como superiora o superior jerárquico de la autoridad responsable, el que de conformidad con las disposiciones correspondientes ejerza sobre ella poder o mando para obligarla a actuar o dejar de actuar en la forma exigida en la sentencia de amparo, o bien para cumplir esta última por sí misma. La autoridad requerida como superiora jerárquica incurre en responsabilidad por falta de cumplimiento de las sentencias, en los términos que las autoridades contra cuyos actos se hubiere concedido el amparo."
  },
  "195": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El cumplimiento extemporáneo de la ejecutoria de amparo, si es injustificado, no exime de responsabilidad a la autoridad responsable ni, en su caso, a su superiora o superior jerárquico, pero se tomará en consideración como atenuante al imponer la sanción penal."
  },
  "196": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
  ...
  "197": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Todas las autoridades que tengan o deban tener intervención en el cumplimiento de la sentencia, están obligadas a realizar, dentro del ámbito de su competencia, los actos necesarios para su eficaz cumplimiento y estarán sujetos a las mismas responsabilidades a que alude este Capítulo."
  },
  "198": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
  ...
  "200": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Recibidos los autos, la Suprema Corte de Justicia de la Nación determinará a la brevedad posible, si existe o no repetición del acto reclamado. En el primer supuesto, tomará en cuenta el proyecto del tribunal colegiado de circuito y procederá a separar de su cargo a la persona titular de la autoridad responsable, así como a consignarlo ante juez o jueza de distrito por el delito que corresponda. Si no hubiere repetición, o si habiéndola, la autoridad no actuó dolosamente y dejó sin efectos el acto repetitivo antes de la resolución de la Suprema Corte de Justicia de la Nación, ésta hará la declaratoria correspondiente y devolverá los autos al órgano judicial que los remitió."
  },
  "201": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    capitulo: "III",
    capitulo_descripcion: "Recurso de Inconformidad",
    seccion: null,
    seccion_descripcion: null,
  ...
  "203": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El órgano jurisdiccional, sin decidir sobre la admisión del recurso de inconformidad, remitirá el original del escrito, así como los autos del juicio al tribunal colegiado de circuito, el cual resolverá allegándose de los elementos que estime convenientes."
  },
  "204": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    capitulo: "IV",
    capitulo_descripcion: "Incidente de Cumplimiento Sustituto",
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El incidente de cumplimiento sustituto tendrá por efecto que la ejecutoria se dé por cumplida mediante el pago de los daños y perjuicios a la persona quejosa."
  },
  "205": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El cumplimiento sustituto podrá ser solicitado por cualquiera de las partes o decretado de oficio por el órgano jurisdiccional que hubiera emitido la sentencia de amparo, en los casos en que: I. La ejecución de la sentencia afecte gravemente a la sociedad en mayor proporción a los beneficios que pudiera obtener la persona quejosa, o II. Por las circunstancias materiales del caso, sea imposible o desproporcionadamente gravoso restituir las cosas a la situación que guardaban con anterioridad al juicio. La solicitud podrá presentarse ante el órgano jurisdiccional que hubiera emitido la sentencia de amparo a partir del momento que ésta cause ejecutoria. El cumplimiento sustituto se tramitará incidentalmente en los términos de los artículos 66 y 67 de esta Ley. En el incidente, el órgano jurisdiccional que hubiera emitido la sentencia determinará si ha lugar o no al cumplimiento sustituto. En caso de resultar favorecida la petición, se abrirá un nuevo incidente para cuantificar el pago de daños y perjuicios. Tanto la determinación sobre la procedencia del cumplimiento sustituto como la que cuantifique los daños y perjuicios serán recurribles mediante el recurso de queja previsto en el artículo 97, fracción I, inciso h) de esta Ley, del cual conocerán los tribunales colegiados de circuito. Independientemente de lo establecido en los párrafos anteriores, la persona quejosa y la autoridad responsable pueden celebrar convenio a través del cual se tenga por cumplida la ejecutoria. Del convenio se dará aviso al órgano judicial de amparo; éste, una vez que se le compruebe que los términos del convenio fueron cumplidos, mandará archivar el expediente."
  },
  "206": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    capitulo: "V",
    capitulo_descripcion: "Incidente por Exceso o Defecto en el Cumplimiento de la Suspensión",
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El incidente a que se refiere este Capítulo procede en contra de las autoridades responsables, por cualquier persona que resulte agraviada por el incumplimiento de la suspensión, sea de plano o definitiva, por exceso o defecto en su ejecución o por admitir, con notoria mala fe o negligencia inexcusable, fianza o contrafianza que resulte ilusoria o insuficiente. Este incidente podrá promoverse en cualquier tiempo, mientras no cause ejecutoria la resolución que se dicte en el juicio de amparo."
  },
  "207": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "El incidente se promoverá ante la jueza o el juez de distrito o el tribunal colegiado de apelación, si se trata de la suspensión concedida en amparo indirecto, y ante la presidenta o el presidente del tribunal colegiado de circuito si la suspensión fue concedida en amparo directo."
  },
  "208": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
  ...
  "213": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el recurso e incidentes a que se refiere este título, el órgano jurisdiccional de amparo deberá suplir la deficiencia de la vía y de los argumentos hechos valer por el promovente."
  },
  "214": {
    titulo: "TERCERO",
    titulo_descripcion: "Cumplimiento y Ejecución",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "No podrá archivarse ningún juicio de amparo sin que se haya cumplido la sentencia que concedió la protección constitucional o no exista materia para la ejecución y así se haya determinado por el órgano jurisdiccional de amparo en resolución fundada y motivada."
  },
  "215": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
    capitulo: "I",
    capitulo_descripcion: "Disposiciones Generales",
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La jurisprudencia se establece por precedentes obligatorios, por reiteración y por contradicción."
  },
  "216": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
  ...
  "219": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La Suprema Corte de Justicia de la Nación, los plenos regionales y los tribunales colegiados de circuito deberán remitir las tesis a la dependencia de la Suprema Corte de Justicia de la Nación encargada del Semanario Judicial de la Federación, para su publicación."
  },
  "220": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el Semanario Judicial de la Federación se publicarán las tesis que se reciban y se distribuirá en forma eficiente para facilitar su conocimiento. Igualmente se publicarán las resoluciones necesarias para constituir o interrumpir la jurisprudencia y los votos particulares. También se publicarán las resoluciones que los órganos jurisdiccionales competentes estimen pertinentes."
  },
  "221": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
  ...
  "222": {
    ...
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
    capitulo: "II",
    capitulo_descripcion: "Jurisprudencia por Precedentes Obligatorios",
    seccion: null,
    seccion_descripcion: null,
  ...
  "224": {
    ...
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
    capitulo: "III",
    capitulo_descripcion: "Jurisprudencia por Reiteración",
    seccion: null,
    seccion_descripcion: null,
  ...
  "225": {
    ...
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
    capitulo: "IV",
    capitulo_descripcion: "Jurisprudencia por Contradicción de Criterios",
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La jurisprudencia por contradicción se establece al dilucidar los criterios discrepantes sostenidos entre los plenos regionales o entre los tribunales colegiados de circuito, en los asuntos de su competencia."
  },
  "226": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Las contradicciones de criterios serán resueltas por: I. Derogada; II. El Pleno de la Suprema Corte de Justicia de la Nación cuando deban dilucidarse los criterios contradictorios sostenidos entre plenos regionales o entre tribunales colegiados de circuito pertenecientes a distintas regiones, y III. Los plenos regionales cuando deban dilucidarse criterios contradictorios entre los tribunales colegiados de circuito de la región correspondiente. Al resolverse una contradicción de criterios, el órgano correspondiente podrá acoger uno de los criterios discrepantes, sustentar uno diverso, declararla inexistente o sin materia. En todo caso, la decisión se determinará por mayoría. La resolución que decida la contradicción de criterios no afectará las situaciones jurídicas concretas de los juicios en los cuales se hayan dictado las sentencias que sustentaron los criterios contendientes."
  },
  "227": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
  ...
  "229": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Interrumpida la jurisprudencia, para integrar la nueva se observarán las mismas reglas establecidas para su formación."
  },
  "230": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
  ...
  "233": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Los plenos regionales, conforme a los acuerdos generales que emita la Suprema Corte de Justicia de la Nación, podrán solicitar a ésta, por mayoría de sus integrantes, que inicie el procedimiento de declaratoria general de inconstitucionalidad cuando dentro de su región se haya emitido jurisprudencia derivada de amparos indirectos en revisión."
  },
  "234": {
    titulo: "CUARTO",
    titulo_descripcion: "Jurisprudencia y Declaratoria General de Inconstitucionalidad",
  ...
  "235": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La declaratoria general de inconstitucionalidad se remitirá al Diario Oficial de la Federación y al órgano oficial en el que se hubiera publicado la norma declarada inconstitucional para su publicación dentro del plazo de siete días hábiles."
  },
  "236": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    capitulo: "I",
    capitulo_descripcion: "Medidas Disciplinarias y de Apremio",
    seccion: null,
    seccion_descripcion: null,
  ...
  "238": {
    ...
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    capitulo: "II",
    capitulo_descripcion: "Responsabilidades y Sanciones",
    seccion: null,
    seccion_descripcion: null,
  ...
  "239": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "No se aplicarán las multas establecidas en esta Ley cuando la persona quejosa impugne actos que importen peligro de privación de la vida, ataques a la libertad personal fuera de procedimiento, incomunicación, deportación o expulsión, proscripción o destierro, extradición, desaparición forzada de personas o alguno de los prohibidos por el artículo 22 de la Constitución Política de los Estados Unidos Mexicanos, así como la incorporación forzosa al Ejército, Armada o Fuerza Aérea nacionales."
  },
  "240": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 11 de esta Ley, si quien promueve no tiene la representación que afirma, se le impondrá multa de setenta a seiscientos noventa Unidades de Medida y Actualización."
  },
  "241": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Tratándose de lo previsto en el artículo 14 de esta Ley, si quien afirma ser defensor o defensora no lo demuestra, se le impondrá una multa de ciento quince a mil ciento cuarenta y cinco Unidades de Medida y Actualización."
  },
  "242": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del párrafo tercero del artículo 16 de esta Ley, a la parte que teniendo conocimiento del fallecimiento de la persona quejosa o de la persona tercera interesada no lo comunique al órgano jurisdiccional de amparo, se le impondrá multa de ciento quince a mil ciento cuarenta y cinco Unidades de Medida y Actualización."
  },
  "243": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso de los artículos 20, párrafo segundo y 24 de esta Ley, si las personas jefas o encargadas de las oficinas públicas de comunicaciones se niegan a recibir o transmitir los mensajes de referencia, se les impondrá multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "244": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 27, fracción III, inciso b) de esta Ley, a la autoridad responsable que no proporcione el domicilio de la persona tercera interesada se le impondrá multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "245": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 28, fracción I de esta Ley, a la autoridad responsable que se niegue a recibir la notificación se le impondrá multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "246": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 28, fracción II de esta Ley, si la persona encargada de la oficina pública de comunicaciones no envía el oficio de referencia, se le impondrá una multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "247": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En los casos de los artículos 32 y 68 de esta Ley, a la persona servidora pública que de mala fe practique una notificación que sea declarada nula se le impondrá una multa de setenta a seiscientos noventa Unidades de Medida y Actualización."
  },
  "248": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Se impondrá multa de setenta a setecientas veces el valor diario de la Unidad de Medida y Actualización a quien para dar competencia a una jueza o un juez de distrito o magistradas o magistrados del tribunal colegiado de apelación, de mala fe designe como autoridad ejecutora a quien no lo sea, siempre que no se reclamen actos que importen peligro de privación de la vida, ataques a la libertad personal fuera de procedimiento, incomunicación, deportación o expulsión, proscripción o destierro, extradición, desaparición forzada de personas o alguno de los prohibidos por el artículo 22 de la Constitución Política de los Estados Unidos Mexicanos, así como la incorporación forzosa al Ejército, Armada o Fuerza Aérea nacionales."
  },
  "249": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En los casos a que se refiere el artículo 49 de esta Ley, si la jueza o el juez de distrito o tribunal colegiado de apelación, no encontraren motivo fundado para la promoción de dos o más juicios de amparo contra el mismo acto reclamado, impondrá al o los infractores multa de ciento quince a mil ciento cuarenta y cinco Unidades de Medida y Actualización, salvo que se trate de los casos mencionados en el artículo 15 de esta Ley."
  },
  "250": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Cuando el órgano jurisdiccional que deseche o desestime una recusación advierta que existan elementos suficientes que demuestren que su promoción se haya dirigido a entorpecer o dilatar el procedimiento en cuestión, se impondrá multa de setenta a seiscientos noventa Unidades de Medida y Actualización."
  },
  "251": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 64 de esta Ley, a la parte que tenga conocimiento de alguna causa de sobreseimiento y no la comunique, se le impondrá multa de setenta a seiscientos noventa Unidades de Medida y Actualización."
  },
  "252": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del párrafo tercero del artículo 68 de esta Ley, cuando se promueva una nulidad que sea declarada notoriamente improcedente se impondrá multa de setenta a seiscientos noventa Unidades de Medida y Actualización."
  },
  "253": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del párrafo segundo del artículo 72 de esta Ley, a la persona responsable de la pérdida de constancias se le impondrá multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "254": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 121 de esta Ley, si la autoridad no expide con oportunidad las copias o documentos solicitados por las partes o los expide incompletos o ilegibles, se le impondrá multa de cincuenta a quinientos días; si a pesar de la solicitud del órgano jurisdiccional de amparo no los remite, o los remite incompletos o ilegibles, se le impondrá multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "255": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 122 de esta Ley, si el juez o jueza de distrito desechare la impugnación presentada, impondrá al promovente que actuó con mala fe multa de setenta a seiscientos noventa Unidades de Medida y Actualización."
  },
  "256": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 145 de esta Ley, si se acredita que la segunda suspensión se solicitó indebidamente y con mala fe, se impondrá multa de ciento quince a mil ciento cuarenta y cinco Unidades de Medida y Actualización."
  },
  "257": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso del artículo 191 de esta Ley, si la autoridad responsable no decide sobre la suspensión en las condiciones señaladas, se impondrá multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "258": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La multa a que se refieren los artículos 192 y 193 de esta Ley será de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "259": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "En el caso de la fracción I de los artículos 236 y 237 de esta Ley, las multas serán de ciento quince a dos mil doscientos noventa y cinco Unidades de Medida y Actualización."
  },
  "260": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Se sancionará con multa de doscientos treinta a dos mil doscientos noventa y cinco Unidades de Medida y Actualización a la autoridad responsable que: I. No rinda el informe previo; II. No rinda el informe con justificación o lo haga sin remitir, en su caso, copia certificada completa y legible de las constancias necesarias para la solución del juicio constitucional u omita referirse a la representación que aduzca la persona promovente de la demanda en términos del artículo 11 de esta Ley; III. No informe o no remita, en su caso, la certificación relativa a la fecha de notificación del acto reclamado, la de presentación de la demanda y de los días inhábiles que mediaron entre uno y otro acto; y IV. No tramite la demanda de amparo o no remita con la oportunidad debida y en los plazos previstos por esta Ley las constancias que le sean solicitadas por amparo o por las partes en el juicio constitucional. Tratándose de amparo contra normas generales, las autoridades que hayan intervenido en el refrendo del decreto promulgatorio de la norma o en su publicación, únicamente rendirán el informe justificado cuando adviertan que su intervención en el proceso legislativo o de creación de la norma general, se impugne por vicios propios. La falta del informe justificado de las autoridades legislativas, además de lo señalado en el párrafo anterior, no dará lugar a sanción alguna. En la inteligencia que ello no impide al órgano jurisdiccional examinar los referidos actos, si advierte un motivo de inconstitucionalidad."
  },
  "261": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    capitulo: "III",
    capitulo_descripcion: "Delitos",
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Se impondrá una pena de dos a seis años de prisión y multa de treinta a trescientos días: I. A la persona quejosa, a su abogada o abogado autorizado o a ambos, si con el propósito de obtener una ventaja procesal indebida, en la demanda afirme hechos falsos u omita los que le consten en relación con el acto reclamado, siempre que no se reclamen actos que importen peligro de privación de la vida, ataques a la libertad personal fuera de procedimiento, incomunicación, deportación o expulsión, proscripción o destierro, extradición, desaparición forzada de personas o alguno de los prohibidos por el artículo 22 de la Constitución Política de los Estados Unidos Mexicanos, así como la incorporación forzosa al Ejército, Armada o Fuerza Aérea nacionales, y II. A la persona quejosa o tercera interesada, a su abogada o abogado o a ambos, si en el juicio de amparo presenten testigos o documentos falsos."
  },
  "262": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
  ...
  "269": {
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "La pérdida de la calidad de autoridad, no extingue la responsabilidad penal por los actos u omisiones realizados para no cumplir o eludir el cumplimiento de la sentencia de amparo cuando la ley le exija su acatamiento."
  },
  "270": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Las multas a que se refiere este Capítulo, son equivalentes a los días multa previstos en el Código Penal Federal."
  },
  "271": {
    titulo: "QUINTO",
    titulo_descripcion: "Medidas Disciplinarias y de Apremio, Responsabilidades, Sanciones y Delitos",
    ...
    seccion: null,
    seccion_descripcion: null,
    texto_completo: "Cuando al concederse definitivamente el amparo a la persona quejosa aparezca que el acto reclamado, además de violar derechos humanos y garantías, cuenta con datos de prueba de un hecho que la ley señala como delito, se pondrá en conocimiento del Ministerio Público que corresponda."
  }
};

// ============================================
// FUNCIÓN AUXILIAR: obtenerTextoArticulo()
// ============================================
export function obtenerTextoArticulo(numero) {
  const key = numero.toString();
  if (ARTICULOS_DETALLE[key]) {
    return ARTICULOS_DETALLE[key].texto_completo;
  }
  return null;
}

// ============================================
// FUNCIÓN AUXILIAR: obtenerMetadataArticulo()
// ============================================
export function obtenerMetadataArticulo(numero) {
  const key = numero.toString();
  if (ARTICULOS_DETALLE[key]) {
    return {
      titulo: ARTICULOS_DETALLE[key].titulo,
      titulo_descripcion: ARTICULOS_DETALLE[key].titulo_descripcion,
      capitulo: ARTICULOS_DETALLE[key].capitulo,
      capitulo_descripcion: ARTICULOS_DETALLE[key].capitulo_descripcion,
      seccion: ARTICULOS_DETALLE[key].seccion,
      seccion_descripcion: ARTICULOS_DETALLE[key].seccion_descripcion
    };
  }
  return null;
}
...
// ============================================
// FUNCIÓN AUXILIAR: obtenerArticuloCompleto()
// ============================================
export function obtenerArticuloCompleto(numero) {
  const key = numero.toString();
  return ARTICULOS_DETALLE[key] || null;
}

export default ARTICULOS_DETALLE;